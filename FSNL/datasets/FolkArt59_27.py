...
class FolkArt59_27(DatasetBase):

    # OOP_dataset_dir = "FolkArt59_OOP"
    # OOP_split_json = "split_Xin_FolkArt59_OOP.json"
    # IP_dataset_dir = "FolkArt27_IP"
    # IP_split_json = "split_Xin_FolkArt27_IP.json"
