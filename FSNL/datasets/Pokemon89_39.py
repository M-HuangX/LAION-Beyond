...
class Pokemon89_39(DatasetBase):

    # OOP_dataset_dir = "Pokemon89_OOP"
    # OOP_split_json = "split_Xin_Pokemon89_OOP.json"
    # IP_dataset_dir = "Pokemon39_IP"
    # IP_split_json = "split_Xin_Pokemon39_IP.json"
