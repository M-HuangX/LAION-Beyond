...
class Architecture50_23(DatasetBase):

    # OOP_dataset_dir = "Architecture50_OOP"
    # OOP_split_json = "split_Xin_Architecture50_OOP.json"
    # IP_dataset_dir = "Architecture23_IP"
    # IP_split_json = "split_Xin_Architecture23_IP.json"
