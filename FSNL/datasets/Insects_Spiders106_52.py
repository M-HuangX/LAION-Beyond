...
class Insects_Spiders106_52(DatasetBase):

    # OOP_dataset_dir = "Insects_Spiders106_OOP"
    # OOP_split_json = "split_Xin_Insects_Spiders106_OOP.json"
    # IP_dataset_dir = "Insects_Spiders52_IP"
    # IP_split_json = "split_Xin_Insects_Spiders52_IP.json"
