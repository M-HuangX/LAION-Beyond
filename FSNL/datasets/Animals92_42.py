...
class Animals92_42(DatasetBase):

    # OOP_dataset_dir = "Animals92_OOP"
    # OOP_split_json = "split_Xin_Animals92_OOP.json"
    # IP_dataset_dir = "Animals42_IP"
    # IP_split_json = "split_Xin_Animals42_IP.json"
