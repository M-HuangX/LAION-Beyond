...
class Plants_Fugi113_56(DatasetBase):

    # OOP_dataset_dir = "Plants_Fugi113_OOP"
    # OOP_split_json = "split_Xin_Plants_Fugi113_OOP.json"
    # IP_dataset_dir = "Plants_Fugi56_IP"
    # IP_split_json = "split_Xin_Plants_Fugi56_IP.json"
