...
class Food53_27(DatasetBase):

    # OOP_dataset_dir = "Food53_OOP"
    # OOP_split_json = "split_Xin_Food53_OOP.json"
    # IP_dataset_dir = "Food27_IP"
    # IP_split_json = "split_Xin_Food27_IP.json"
