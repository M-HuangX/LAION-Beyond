...
class Attire54_28(DatasetBase):

    # OOP_dataset_dir = "Attire54_OOP"
    # OOP_split_json = "split_Xin_Attire54_OOP.json"
    # IP_dataset_dir = "Attire28_IP"
    # IP_split_json = "split_Xin_Attire28_IP.json"
