...
CUSTOM_TRAINING_HINT_PROMPT = {
    ...
    "FolkArt": "folk art",
    "Food": "food",
    "Insects_Spiders": "insect or spider",
    "Landmark": "landmark",
    "Plants_Fugi": "plant or fungus",
}
...
class NameLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        HINT = CUSTOM_TRAINING_HINT_PROMPT[cfg.DATASET.SUBFIELD]
        self.set_type = HINT
...
class FSNL_openclip_GCD(TrainerX):
    ...
    def build_model(self):
        ...
        # Model info
        if self.cfg.TRAINER.FSNL.USE_CAPTION:
            default_log_template["Method"] = str(self.cfg.TRAINER.NAME) + '-Caption'
        else:
            default_log_template["Method"] = str(self.cfg.TRAINER.NAME) + '-Without_Caption'
        ...
        default_log_template["SUBFIELD"] = self.cfg.DATASET.SUBFIELD
        default_log_template["NUM_CLUSTER"] = len(classnames)
    ...
    def test(self, split=None):
        ...
        for batch_idx, batch in enumerate(tqdm(data_loader)):
            ...
            self.evaluator.process(output, label, impath)
