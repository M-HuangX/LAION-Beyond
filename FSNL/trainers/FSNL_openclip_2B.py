...
def load_clip_to_cpu(cfg):
    ...
    model, _, preprocess = open_clip.create_model_and_transforms(
        backbone_name, precision=cfg.TRAINER.FSNL.PREC, pretrained='/data/chenziliang/.cache/huggingface/hub/models--laion--CLIP-ViT-g-14-laion2B-s12B-b42K/open_clip_pytorch_model.bin')
    model.eval()
...
class FSNL_openclip_2B(TrainerX):
