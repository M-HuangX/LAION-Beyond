...
class TextEncoder(nn.Module):
    ...
    def forward(self, prompts, tokenized_prompts):  # second arg is embedding, third is BPE encoding
...
class CoOp_openclip(TrainerX):
    ...
    def build_model(self):
        ...
        # Model info
        if cfg.TRAINER.COOP.CSC:
            default_log_template["Method"] = str(self.cfg.TRAINER.NAME) + "-CSC"
        else:
