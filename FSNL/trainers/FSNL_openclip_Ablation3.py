...
class CustomCLIP(nn.Module):
    ...
    #####
    def forward_clip_loss(self, image, caption):
        # No caption swap mechanism
        ...
        image_loss = self.contrastive_loss(logits_per_image)
...
class FSNL_openclip_Ablation3(TrainerX):
        ...
        if prec == "amp":
            with autocast():
                if self.FSNL_USE_CAPTION:
                    ...
                    loss1 = self.model.forward_clip_loss(image_features, caption)
                    # Ablation
