...
import random
import sys
sys.path.append('/data/chenziliang/Rememory/EVA/EVA-CLIP/rei')
from eva_clip import create_model_and_transforms, get_tokenizer
from eva_clip.tokenizer import SimpleTokenizer as _Tokenizer
...
def load_clip_to_cpu(cfg):
    ...
    pretrained = "/data/chenziliang/EVA01_CLIP_g_14_psz14_s11B.pt"
...
class TextEncoder(nn.Module):
    def __init__(self, clip_model):
        ...
        self.dtype = clip_model.visual.get_cast_dtype()
...
class NameLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        # Modified for OpenCLIP compatibility
        # Iterate over all parameters of clip_model
        self.dtype = clip_model.visual.get_cast_dtype()
...
class EVA_FSNL_400M(TrainerX):
    ...
    def build_model(self):
        ...
        # Modified section
        if cfg.TRAINER.FSNL.PREC == "fp32" or cfg.TRAINER.FSNL.PREC == "amp":
