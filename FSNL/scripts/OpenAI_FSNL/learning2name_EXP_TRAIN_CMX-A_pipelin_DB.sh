...
do
    ...
    DIR=/mnt/HDD_2TB/ziliang_files/output/learning2name/train/${DATASET}/FLE_${FLE}_NCTX_${NCTX}_CIFC_${CIFC}/shots_${SHOTS}/${TRAINER}/SWAP_VERSION_${VERSION}/MEPOCH_${MAX_EPOCH}_BS_${BATCH_SIZE}_LR_${LR}_MIX_${MIX}/seed${SEED}
