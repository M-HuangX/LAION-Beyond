...
def main(args):
    # 构建NPZ文件路径
    npz_file_path = os.path.join(laion_beyond_root, f'{args.subfield}_mixed_clustering_results_kmeans.npz')
    ...
    # 构建输出JSON文件路径
    output_json_path = os.path.join(laion_beyond_root, f'{args.subfield}_mixed_clustering_results_kmeans.json')
